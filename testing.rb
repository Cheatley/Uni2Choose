...
db = SQLite3::Database.new('scotlandunis.sqlite3')                           
db.execute 'CREATE TABLE "scotlandunis" ("uname" string(60) NOT NULL)'
    ...
    def process_courses_page(course_page)
        ...
        while next_page_link
            ...
            course_page.search('ol.resultscontainer li').each do |course|
                ...
                course_info[:name]          = clean_text(course.search('h4').text)
