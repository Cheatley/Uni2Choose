...
db = SQLite3::Database.new('su.sqlite3')                           
db.execute 'CREATE TABLE "su" ("uname" string(60) NOT NULL)'
db.execute 'CREATE TABLE "suc" ("uname" string(60), "cname" string(400) NOT NULL, "duration" string(60), "qualification" string, "url" string, "entry" string)'
    ...
    def process_unis
        ...
        while  next_page_link
            ...
            @page.search('li.result').each do |uni|
                ...
                db = SQLite3::Database.open('scotlandunis.sqlite3')

                db.execute "INSERT INTO scotlandunis (uname) VALUES ('#{uni_name[0..60]}')"
        ...
        while next_page_link
          ...
          next_page_link = course_page.search('.pager a[text()=">"]').first        
            if(next_page_link) 
                ...
                db = SQLite3::Database.open('su.sqlite3')

            db.execute "INSERT INTO suc (uname, cname, duration, qualification, url, entry) VALUES ('#{@uni_name[0..60]}', #{@course_name[0..200]}', '#{@course_duration}', '#{@course_qual}', '#{@details_entry}', '#{@requirements}')"
    ...
    def process_course_details(course_details)
        ...
        entry_link = true
             ...
             if entry_link
                 ...
                 @details_entry = clean_link(@details_entry)
